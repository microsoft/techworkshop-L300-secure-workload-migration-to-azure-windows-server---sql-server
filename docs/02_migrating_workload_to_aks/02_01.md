...
7. From the terminal at the `aks_demo_app` directory, run the following to install the required npm dependencies:
    ...
    - `npm install` - If you don't have npm installed, please find the download and setup instructions [here](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm)
