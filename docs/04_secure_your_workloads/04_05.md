...
2. Connect to the **tailspin web app cm resource in your resource group** and using **Microsoft Edge** navigate to **https://www.bing.com**. You should be able to access **Microsoft Bing**.

3. In the Azure portal, in the **Search resources, services, and docs** text box at the top of the portal, search for  **hub-vnet**, then select the found Virtual Network.
...
8. On the **Basics** tab, enter the following values, then select **Add new** on the **Firewall policy** section.
    ...
    - **Name**: `Hub-fw`
    - **Region**: Select the same region where your other resources in your resource group are located.  Note: If you choose a difference region this won't work.
...
33. On the **hub-fw-pol** Firewall Policy blade, in the **Rules** section, select **Application rules**.
