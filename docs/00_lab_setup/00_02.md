...
4. On the **Create a resource group** Basics tab:
    ...
    - **Region**: Select a region where you have available SQL MI compute and networking capacity.

        > **IMPORTANT**: You can run the `Hands-on lab\resources\precheck-quota.ps1` PowerShell script to check the available quota by region in your subscription.
