...
# Task 02 - Enable ESU via Azure Arc

## Introduction

Tailspin Toys needs to activate Extended Security Updates (ESU) for legacy Windows and SQL workloads using Azure Arc.

## Description

In this task, you will use the Azure Arc blade to enable ESU for Windows Server SQL Server. This replaces traditional volume licensing with a streamlined cloud-based entitlement.

## Success Criteria

* ESU enabled for Windows Server and SQL Server.
* Azure Arc reflects ESU status.
