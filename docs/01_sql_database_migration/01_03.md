...
5. In the **Connect to Server** dialog, enter:
   ...
   - **User name**: Enter your Entra username (email)
   - Enable **Remember password** and **Trust server certificate**
   - Select **Connect** and complete the login process in the web browser

   Or, using **SQL Auth** (disabled for most during deployment):

   - **Server type**: `Database Engine`
   - **Server name**: Paste the host name of your SQL Managed Instance
   - **Authentication**: `Sql Server Authentication`
   - **Login**: `demouser`
   - **Password**: Enter the password you provided for the `demouser` Admin login when deploying your resources to Azure
   - Enable **Remember password** and **Trust server certificate**
   - Select **Connect**
