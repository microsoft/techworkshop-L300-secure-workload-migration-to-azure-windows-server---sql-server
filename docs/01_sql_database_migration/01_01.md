...
5. In the Azure portal, enter "azure arc" into the search bar, and select **Azure Arc (Classic)** under **Services** in the results.
...
14. Run the following command:
    ...
    > **IMPORTANT**: If you receive the error, 'Cannot install Azure Connected Machine agent on an Azure Virtual Machine. Azure Connected Machine Agent is designed for use outside Azure,' execute the steps in PowerShell found in the [step-by-step guide to enable Azure Arc on an Azure VM](https://learn.microsoft.com/azure/azure-arc/servers/plan-evaluate-on-azure-virtual-machine#step-by-step-guide) to prepare your VM.
